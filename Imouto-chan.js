...
//ALL PREVIOUS CODE IS FOR BEFORE SLASH COMMAND IMPLIMENTATION
...
bot.on('interactionCreate', async interaction => {
	...
	try {
		...
		console.error(error);
		await interaction.reply({ content: 'There was an error executing this command, desu!', ephemeral: true});
	}
});
